...
`.design_rules/*.mdc` 파일의 YAML frontmatter:
...
### CRITICAL (절대 위반 불가)
@.design_rules/project-summary.mdc
...
### MUST (반드시 준수)
@.design_rules/design-system.mdc
@.design_rules/project-directory-rules.mdc

### SHOULD (관련 작업 시 준수)
@.design_rules/storybook-writing.mdc
@.design_rules/mui-custome-theme.mdc
